...
export class ResumenComponent implements OnInit {
  ...
  calcularAportes(){this.info['cuotaAportes']=this.formatNumber(Number(this.info['ingresos'].replace(/[^0-9]/g, '')||0)*0.06);
    ...
    this.resumenFlujoCaja.chartData.datasets = [
      {
        label: 'Pago Mensual',
        data: [
          this.situacionActual?.['pagoMensual'] ? Number(this.situacionActual['pagoMensual'].replace(/[^0-9]/g, '')) : 0,
          this.situacionFutura?.['pagoMensual'] ? Number(this.situacionFutura['pagoMensual'].replace(/[^0-9]/g, '')) : 0
        ],
        backgroundColor: 'rgba(75, 192, 192, 0.6)', // Stack 1 color
        borderColor: 'rgba(75, 192, 192, 1)',
        borderWidth: 1,
      ...
      },
      {
        label: 'Aportes',
        data: [
          this.situacionActual?.['aportes'] ? Number(this.situacionActual['aportes'].replace(/[^0-9]/g, '')) : 0,
          this.situacionFutura?.['aportes'] ? Number(this.situacionFutura['aportes'].replace(/[^0-9]/g, '')) : 0
        ],
